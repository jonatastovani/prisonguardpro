    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-12">
                        <label for="artigo_idModalCadastroPresoArtigo" class="form-label">Cidade Nascimento</label>
                        <br>
                        <select name="artigo_id" id="artigo_idModalCadastroPresoArtigo" class="form-select" style="width: 100%;">
                            <option value="1">Valor 1</option>
                            <option value="2">Valor 2</option>
                        </select>

                        {{-- <label for="artigo_idModalCadastroPresoArtigo" class="form-label">Artigo</label>
                            <select name="artigo_id" id="artigo_idModalCadastroPresoArtigo"
                                class="form-select"></select> --}}
                        {{-- <button id="btnArtigosCadastro" class="btn btn-outline-secondary"><i
