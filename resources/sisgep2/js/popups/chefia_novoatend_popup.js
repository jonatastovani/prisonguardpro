...
function abrirPopNovoAtend(idpreso=0){
    atualizaListagemComum('busca_presos',{tipo: 2, tipobusca: 2, valor: 1, tiporetorno:2, idvisualizacao:idvisu, blnvisuchefia:true},$('#listapresospopnovoatend'),$('#selectpresopopnovoatend'));
