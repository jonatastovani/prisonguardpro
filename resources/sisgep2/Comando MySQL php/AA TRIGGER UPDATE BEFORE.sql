DROP TRIGGER IF EXISTS nome_tabela_UPDATE_BEFORE;

delimiter $
CREATE TRIGGER nome_tabela_UPDATE_BEFORE
...
BEGIN
    ...
    IF valorAntigo <> valorNovo THEN
		INSERT INTO nome_tabela_log (IDREFERENCIA, CAMPOATUALIZADO, ANTIGO, NOVO, IDATUALIZACAO, DATAATUALIZACAO, IPATUALIZACAO)
