DROP TRIGGER IF EXISTS cimic_ordens_apresentacoes_UPDATE_BEFORE;

delimiter $
CREATE TRIGGER cimic_ordens_apresentacoes_UPDATE_BEFORE
BEFORE UPDATE ON cimic_ordens_apresentacoes
FOR EACH ROW
...
BEGIN
    ...
    IF valorAntigo <> valorNovo THEN
		INSERT INTO cimic_ordens_apresentacoes_log (IDREFERENCIA, CAMPOATUALIZADO, ANTIGO, NOVO, IDATUALIZACAO, DATAATUALIZACAO, IPATUALIZACAO)
