DROP TRIGGER IF EXISTS tab_artigos_UPDATE_BEFORE;

delimiter $
CREATE TRIGGER tab_artigos_UPDATE_BEFORE
BEFORE UPDATE ON tab_artigos
FOR EACH ROW
...
begin
    ...
    IF valorAntigo <> valorNovo THEN
		INSERT INTO tab_artigos_log (IDARTIGO, CAMPOATUALIZADO, ANTIGO, NOVO, IDATUALIZACAO, DATAATUALIZACAO, IPATUALIZACAO)
