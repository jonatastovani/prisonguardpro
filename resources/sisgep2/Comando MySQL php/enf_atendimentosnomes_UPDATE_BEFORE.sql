DROP TRIGGER IF EXISTS enf_atendimentosnomes_UPDATE_BEFORE;

delimiter $
CREATE TRIGGER enf_atendimentosnomes_UPDATE_BEFORE
BEFORE UPDATE ON enf_atendimentosnomes
FOR EACH ROW
...
BEGIN
    ...
    IF valorAntigo <> valorNovo THEN
		INSERT INTO enf_atendimentosnomes_log (IDREFERENCIA, CAMPOATUALIZADO, ANTIGO, NOVO, IDATUALIZACAO, DATAATUALIZACAO, IPATUALIZACAO)
