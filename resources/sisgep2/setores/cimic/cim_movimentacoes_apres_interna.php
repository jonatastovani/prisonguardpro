...
<div class="titulo-pagina">
    <h1 id="titulo">Incluir Apresentação Interna</h1>
</div>
...
<div class="form">
    ...
    <div class="grupo-block">
        <h4 class="titulo-grupo">Dados da(s) Apresentação(ões)</h4>
        <div class="grupo-block">
            <label for="searchapres">Cód. Apres</label>
            <input type="search" id="searchapres" list="listaapresentacoes" style="width: 90px;" autocomplete="off">
            <datalist id="listaapresentacoes"></datalist>
            <label for="selectapres" class="margin-espaco-esq">Selecione a Apresentação</label>
            <select id="selectapres" style="width: 100%; max-width: 420px;">
        ...
        <div class="grupo">
            <label for="datasaida">Data da Apresentação</label>
...
<script src="js/cimic/cim_movimentacoes_apres_interna.js"></script>
