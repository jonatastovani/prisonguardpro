...
<div class="titulo-pagina">
    <h1 id="titulo">Gerenciar Apresentações</h1>
</div>
...
<div class="form">    
    <div class="grupo" style="border: none; padding: 0; display: flex;">
        ...
        <div class="grupo largura-restante">
            ...
            <label for="ordemnome">Nome Preso</label>
            <input type="radio" name="ordem" id="ordemdata" value="3" class="margin-espaco-esq">
            <label for="ordemdata">Data Apres.</label>
            <input type="radio" name="ordem" id="ordemlocal" value="4" class="margin-espaco-esq">
            <label for="ordemlocal">Local Apres.</label>
        </div>
    </div>
    ...
    <div class="ferramentas">
        <button id="imp_oficio">Imp Apresentação</button>
...
<script src="js/cimic/cim_gerenciar_apresentacoes.js"></script>
