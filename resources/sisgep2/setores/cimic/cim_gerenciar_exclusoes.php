...
<div class="titulo-pagina">
    <h1 id="titulo">Gerenciar Exclusões</h1>
</div>
...
<div class="form">    
    ...
    <div class="ferramentas">
        <button id="openpopexclusoes">Nova Exclusão</button>
...
<?php 
include_once "popups/cim_exclusoes_popup.php";
?>
<script src="js/cimic/cim_gerenciar_exclusoes.js"></script>
