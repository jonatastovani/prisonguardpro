...
<div class="titulo-pagina">
    <h1 id="titulo">Incluir Transferência</h1>
</div>

<div class="form">
    <div class="grupo">
        <label for="incluir">Nova Transferência</label>
        <input type="radio" name="acao" id="incluir" value="incluir" checked>
        <label for="alterar" class="espaco-esq">Alterar Transferência</label>
    ...
    <div class="grupo-block">
        ...
        <div class="grupo-block">
            ...
            <select name="selectordem" id="selectordem" style="width: 100%; max-width: 460px;">
                <option value="0">Selecione</option>
            </select>
        </div>
        <div class="grupo-block">
            <label for="searchdestino">Cód. Destino</label>
            <input type="search" id="searchdestino" list="listaunidades" style="width: 90px;" autocomplete="off">
            <datalist id="listaunidades"></datalist>
            <label for="selectdestino" class="espaco-esq">Destino</label>
            <select id="selectdestino" class="locaisunidades" style="width: 100%; max-width: 540px;">
    ...
    <div class="ferramentas">
        <button id="openunidades">Inserir/Alterar Destinos</button>
        <button id="novolocal" class="margin-espaco-esq">Inserir/Alterar Local Apres.</button>
...
<?php 
    include_once "popups/unidades_popup.php";
?>

<script src="js/cimic/cim_movimentacoes_transferencias.js"></script>
