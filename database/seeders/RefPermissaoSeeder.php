...
class RefPermissaoSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $data = [
            ...
            [
                'id' => 6,
                'nome' => 'Permissão geral do Setor de Inclusão',
                'nome_completo' => null,
                'descricao' => 'Permissão com acesso a todas áreas relacionadas a inclusão; Esta permissão dispensa a atribuição das permissões específicas de cada área do setor.',
            ],
            // [
            //     'id' => 7,
